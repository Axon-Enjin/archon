    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-brand-surface">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm text-brand-muted font-sans font-medium">Authenticating Agent Session...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-brand-primary overflow-hidden">
              <Image src="/archon.svg" alt="Archon Agent Logo" width={36} height={36} className="w-full h-full object-contain" />
            </div>
        ...
        {loading ? (
          <div className="flex flex-1 items-center justify-center bg-zinc-50">
            <div className="text-center">
              ...
              <p className="mt-3 text-xs text-brand-muted font-sans font-semibold">Loading agent queue...</p>
            </div>
          </div>
        ) : (
          <>
            ...
            <section className="flex-1 bg-brand-surface flex flex-col overflow-y-auto p-6 md:p-10 space-y-6">
              {selectedTicket ? (
                  ...
                  <>
                    ...
                    {handoff && (
                      <div className="rounded-xl border border-brand-primary/20 bg-brand-primary-light/10 p-6 space-y-4">
                        ...
                        <div className="text-xs">
                          ...
                          <p className="text-brand-muted mt-1 leading-relaxed font-sans">
                        ...
                        {messages.map((msg) => (
                          <div key={msg.id} className="pt-3 first:pt-0">
                            ...
                            <MarkdownText
                              ...
                              className="text-brand-text mt-1 font-sans"
                            />
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="rounded-xl bg-white border border-zinc-200 p-6 shadow-sm space-y-4">
                      ...
                      <textarea
                        ...
                        disabled={resolving}
                        className="w-full rounded-xl border border-zinc-200 bg-brand-surface p-4 text-xs focus:border-brand-primary focus:outline-none min-h-[100px] leading-relaxed font-sans"
                      />
                ...
                <div className="flex-grow flex flex-col items-center justify-center text-center space-y-3">
                  ...
                  <p className="text-xs text-brand-muted max-w-sm font-sans">
